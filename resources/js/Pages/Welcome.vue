    ...
    >
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="flex border mt-5">
                <ResponsiveNavLink href="buttons">Button</ResponsiveNavLink>
                <ResponsiveNavLink href="alerts">Alert</ResponsiveNavLink>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    ...
                    >
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Software Package ที่ใช้งานร่วมกับ Project</h2>
                            <ul class="text-sm mt-2 ml-4 leading-relaxed list-disc">
                                <li>Headlessui => (https://headlessui.com/)</li>
                                <li>Heroicons => (https://heroicons.com/)</li>
                                <li>Class Variance Authority => (https://cva.style/docs)</li>
                                <li>lodash => (https://lodash.com/) </li>
                            </ul>
                        </div>
