...
<template>
    ...
    >
        <ComboboxButton
            ...
            class="min-h-[2.5rem] relative flex w-full flex-wrap items-center gap-1 overflow-hidden rounded-md border-2 bg-white p-1 pr-14 text-sm focus-within:border-blue-500 focus-within:!bg-white hover:bg-gray-100 focus:ring-0"
        >
